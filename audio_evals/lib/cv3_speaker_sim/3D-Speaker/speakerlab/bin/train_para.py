...
parser.add_argument(
    "--pretrained_model_dir", default="pretrained", type=str, help="Local model dir"
)
...
def main():
    ...
    # Paraformer model
    asr_model, _ = build_model_from_file(
        asr_train_config, asr_model_file, cmvn_file, device="cuda", mode="paraformer"
    )
