...
parser = argparse.ArgumentParser(
    description="Extract visual speaker embeddings for diarization."
)
...
parser.add_argument(
    "--onnx_dir", default="", type=str, help="Pretrained onnx directory"
)
...
def main():
    ...
    for vpath in videos:
        ...
        assert len(subset) > 0, "[ERROR] No vad info found in %s for %s." % (
            args.vad,
            vpath,
        )
