...
def main(args):
    ...
    if args.ref_rttm != "":
        ...
        msg = ", ".join(
            ["MS: %f" % MS, "FA: %f" % FA, "SER: %f" % SER, "DER: %f" % DER_]
        )
        logger.info(msg)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--exp_dir", type=str, default="", help="exp dir")
    parser.add_argument("--ref_rttm", type=str, default="", help="ref rttm file")
