...
parser.add_argument(
    ...
    help="Original audio data dir.",
)
parser.add_argument(
    "--audio_out_dir", type=str, default="clips_audios/val", help="Audio output dir."
)
...
if __name__ == "__main__":
    ...
    for entity in entity_list:
        pool.apply_async(
            extract_one_entity, args=(entity, args.audio_ori_dir, args.audio_out_dir)
        )
