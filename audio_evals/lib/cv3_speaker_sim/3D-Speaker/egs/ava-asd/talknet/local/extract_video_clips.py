...
parser.add_argument(
    "--csv_ori", type=str, default="val_orig.csv", help="Original CSV file."
)
parser.add_argument(
    "--video_ori_dir",
    type=str,
    default="orig_videos/trainval",
    help="Original video data dir.",
)
parser.add_argument(
    "--video_out_dir", type=str, default="clips_videos/val", help="Video output dir."
)
...
if __name__ == "__main__":
    ...
    def extract_one_entity(entity, input_dir, output_dir):
        ...
        for _, row in ins_data.iterrows():
            image_filename = os.path.join(
                ins_dir, str("%.2f" % row["frame_timestamp"]) + ".jpg"
            )
    ...
    for entity in entityList:
        pool.apply_async(
            extract_one_entity, args=(entity, args.video_ori_dir, args.video_out_dir)
        )
