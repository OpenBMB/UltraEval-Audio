...
- **One-Click Benchmark Management 📥**: Say goodbye to tedious manual downloading and data processing. UltraEval-Audio automates it all, letting you easily acquire the benchmark data you need.
- **Built-in Evaluation Tools ⚙️**: No need to hunt for evaluation tools. UltraEval-Audio includes 8 common evaluation metrics (e.g., WER, WER-ZH, BLEU, G-Eval), satisfying both rule-based and model-driven needs.
...
# Contact Us
If you have any suggestions or questions, please file an issue or join our discord group: https://discord.gg/PHGy66QP
